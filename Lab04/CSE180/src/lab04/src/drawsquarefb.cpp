...
void odometryRecieved(const nav_msgs::msg::Odometry::SharedPtr msg) {
	double roll, pitch, yaw;
//	std/msg coversion to tf2 object
...
int main(int argc,char **argv) {
  ...
  auto sub = nodeh->create_subscription<nav_msgs::msg::Odometry>("p2dx/odom",1000,&odometryRecieved);
